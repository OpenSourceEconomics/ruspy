...
dict_df ={}
list_pkl = os.listdir('data/pkl/group_data/')
...
for j, i in enumerate(sorted(dict_df.keys())):
    ...
    if j == 0:
        ...
        df_ges = pd.concat([df_ges, df4.rename(columns={group_name: 'Full sample'})], axis=0)
