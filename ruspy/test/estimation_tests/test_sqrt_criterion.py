"""
test get_criterion_function for NFXP and square root cost function
"""
import numpy as np
import pandas as pd
import pytest
...
def outputs():
    out = {}
    out["params_base"] = np.loadtxt(TEST_FOLDER + "repl_params_sqrt.txt")
    out["cost_ll"] = 163.390  # 163.395.
    return out
